...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/widget.js":[function(require,module,exports) {
...
document.addEventListener('DOMContentLoaded', function (event) {
  ...
  function main() {
    var iframe, plugin_service, styles; // Declare our variables

    var elms = document.querySelectorAll("[id='musaeus-app-widget']"); // Get all musaeus-app-widget id's
    ...
    for (var i = 0; i < elms.length; i++) {
      ...
      if (typeof plugin == 'undefined') {
        break;
      } // If no plugin data is specified break the loop 
      ...
      if (plugin_service == 'video') {
        // We need diferent atributes for the video plugin
      ...
      iFrameResize({
        log: false,
        bodyMargin: '10px'
      }, '#frame' + i); // And we use Iframe Resizer library to determine the height
    }
  }
});
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/widget.js"], null)
//# sourceMappingURL=/widget.39d5497d.js.map